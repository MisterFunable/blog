...
# Figma Body Alternatives: From Archetypes to... Art

Exchanging accessories between Figma figures is common. But what about swapping bodies? Are there alternatives to the standard Archetype She? Like, more... interesting bodies? Yes, and this post covers those options.

<!-- Image Source: https://myfigurecollection.net/picture/2034948&context%5B%5D=itemId%3A630253 -->
![Background by [Kulizac](https://myfigurecollection.net/picture/2034948&context%5B%5D=itemId%3A630253).](https://miro.medium.com/1*VdcqRL9Iphu-Cik1KP8KTg.png)

The artistic expression of the feminine form has been celebrated throughout history, from classical sculptures to modern photography. Now there are new ways to express and compose, and people out there sharing and making things worth admiring. This isn't something to be ashamed of. It's art.

> **TL:DR:** I only care about female bodies. Male bodies exist but won't be covered here.
Also, I'm blurring some pics because there is a place and time for everything.

---

## What Led Me Here

Bad decisions and alcohol, but besides that... [My Figure Collection (MFC)](https://myfigurecollection.net/), I love it! It's truly helpful to keep track of and find new products from many lines.

It also allows users to upload pictures and associate products with them, helping you discover pictures from figures that you own or are interested in.

And one of those pictures was this one:

<!-- Image Source: https://myfigurecollection.net/picture/2034948&context%5B%5D=itemId%3A630253 -->
![Uncensored version [here](https://myfigurecollection.net/picture/2034948&context%5B%5D=itemId%3A630253) (login required). By [Kulizac](https://myfigurecollection.net/picture/2034948&context%5B%5D=itemId%3A630253).](https://miro.medium.com/1*NxO3lIuUrYatIwkgXLZ87g.png)

Yeah, a lot of NSFW bodies and multiple characters, some not directly Figma but you get the idea.

What brand were those? That question stayed in the back of my head for a few years. Until recently when talking with a friend, I gave it another try to find the picture and by extension the brand. You could say _I tried harder_.
...
<!-- Image Source: https://myfigurecollection.net/picture/2279891&context%5B%5D=itemId%3A676262 -->
![[Pic](https://myfigurecollection.net/picture/2279891&context%5B%5D=itemId%3A676262) by **R**odimus1138](https://miro.medium.com/1*-Rc4HtsA54CfYKV5HEwP9g.png)

Something more "official", 100% compatible with Figma body, and no articulations. A statue basically. Amazing!
...
Figma is not technically 1/12 scale. It's "kinda 1/12". That only means the sizes won't match perfectly between franchises since they prioritize proportions.

I personally divide them into these two categories:

- **Anime:** Similar proportions, but head/body dimensions vary by series. Parts are interchangeable, though some combinations look odd. Like a **Madoka Magica** head on a **Fate** figure.

- **Video Game:** Slim and long faces, more realistic than anime. **Persona**, **Fire Emblem**, **Zelda** figures fall here.

This matches the two types of Archetype bodies, so I'm not that crazy.

### Prices

Bodies can range from $20 to $100 USD (and even more), depending on the product line. Old discontinued products will be either too expensive or hard to find. If you find one at a good price, buy it.
...
> With that clear, let's move to the fun part!

---

## Articulated Bodies

We're skipping seamless doll bodies because that's a whole other thing.
...
Now that I recall, [Mio (XC3)](https://myfigurecollection.net/item/1618550) was quite big, even for 02 standards.
...
### Semi Seamless (AliExpress, Can't recall the brand)

These don't work with Figmas. They use ball-joint neck connections designed for doll heads, not Figma's peg system.
...
> Until this point, there aren't many options, but we're getting somewhere.
...
A friend shared this line with me which kickstarted my search for bodies with... anatomical details and the creation of this post. There's one at my local store (size L, brown), but that color is hard to pair with most heads. I'll still make a video about it.
...
1. [Review Hobby Base 1/12 Material-chan S Light Fresh](http://blog.livedoor.jp/nobuno88/archives/1077982375.html)
...
And the **S** in **S-Style** stands for **swimsuits**!

The problem? Prices are inconsistent and can get ridiculous. Some characters cost $50, others $100+. If you want a specific character in a bikini and there's no regular Figma version (like from Fate or Figma Styles), this is your option.
...
These are garage kits, so expect mold lines and some assembly required. For what you get, that's acceptable. The catch? Only available from their [official store](https://momoken.wonder-remix.jp/prdc_info.html), but as stated on their [shop](http://wonder-remix.shop-pro.jp/) they are no longer selling 1/12 figures 😭
...
Lines I'm aware of but haven't tested/checked compatibility:

## S.H.Figuarts Body-chan

<!-- Image Source: https://myfigurecollection.net/?current=title&title=Body-chan&rootId=0&orEntries%5B%5D=23382&_tb=item&mode=browse&tab=search&output=2&sort=insert&order=desc&year=2025&month=11&domainId=-1 -->
![[Search query here](https://myfigurecollection.net/?current=title&title=Body-chan&rootId=0&orEntries%5B%5D=23382&_tb=item&mode=browse&tab=search&output=2&sort=insert&order=desc&year=2025&month=11&domainId=-1)](https://miro.medium.com/1*Ja6Tj2dHdu5wcKhOM6aCnQ.png)

These work well with other Bandai lines like S.H. Figuarts. Figma compatibility is unclear. [Search here](https://myfigurecollection.net/item/572059) for compatibility examples.
...
That covers the main body options available. I've wanted to write this guide for a while, and now I finally have all the info. There's a huge 1/12 world out there, but my next goal is getting one or more Ero Sotai Bodies.

If you know other brands, have corrections, or comments, let me know so I can improve this!

And if you've read this far, you deserve a [bonus section](https://medium.com/@mister.funable/figma-bodies-bonus-section-027b2243d5f7).
